...
//EmployeeManagementApp.java: Contains the main method and handles user interactions. This is the entry point of the application.
//also print when we give id it print all the date 
